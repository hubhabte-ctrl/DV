...
export function AssetFolderTree({ search }: { search: string }) {
  const m = getManifest();
...
export function AssetLibraryPanel({ search }: { search: string }) {
  const m = getManifest();
    ...
    <>
      <div className="bs-row bs-asset-tab-filters">
        ...
        <button
          ...
          title="Import assets - 3D, images, SVG, video, audio, fonts, textures, HDR"
                ...
                <div className="uk-assetcard__actions">
                  ...
                  <button
                    ...
                    onClick={() => {
                      ...
                      else toast(`${a.name} is in use — remove references first`);
                    }}
                  >
                    {Icons.trash}
                  </button>
