    ...
    return (
      <div className="mslot-wrap">
        ...
        <CollapsibleSection title="Surface">
          <PBRSliderRow label="Metallic"     value={metallic}    min={0} max={1} step={0.05} scale={100} unit="%" disabled={isProtected} onChange={(v: any) => updateProp('metallic', v)}               onScrub={(v: any) => updateProp('metallic', v)} />
          <PBRSliderRow label="Roughness"    value={roughness}   min={0} max={1} step={0.05} scale={100} unit="%" disabled={isProtected} onChange={(v: any) => updateProp('roughness', v)}              onScrub={(v: any) => updateProp('roughness', v)} />
          <PBRSliderRow label="Normal Scale"    value={normalScale} min={0} max={2} step={0.05}             disabled={isProtected} onChange={(v: any) => updateExtProp('normalScale', v)} onScrub={(v: any) => updateExtProp('normalScale', v, true)} />
        </CollapsibleSection>
        ...
        <CollapsibleSection title="Emission">
          ...
          <PBRSliderRow label="Intensity" value={emissivePower} min={0} max={10} step={0.1}
            ...
            onChange={(v: any) => updateProp('emissiveIntensity', v)}
            onScrub={(v: any)  => updateProp('emissiveIntensity', v)} />
        </CollapsibleSection>

        {/* 4  "  "  Opacity & Alpha  "  "  "  "  "  "  "  "  "  "  "  "  "  "  "  "  "  "  "  "  "  "  "  "  "  "  "  "  "  "  "  */}
        <CollapsibleSection title="Opacity">
          <PBRSliderRow label="Opacity" value={opacity}     min={0} max={1} step={0.05} scale={100} unit="%" disabled={isProtected} onChange={(v: any) => updateProp('opacity', v)}              onScrub={(v: any) => updateProp('opacity', v)} />
          <PBRSliderRow label="AO"      value={aoIntensity} min={0} max={1} step={0.05} scale={100} unit="%" disabled={isProtected} onChange={(v: any) => updateExtProp('aoIntensity', v)} onScrub={(v: any) => updateExtProp('aoIntensity', v, true)} />
          <FieldRow label="Alpha Mode">
            <SegmentedControl
              ...
              onChange={(v: any) => updateProp('alphaMode', v)}
            />
          </FieldRow>
        </CollapsibleSection>
    ...
    return (
      <div className="mslot-wrap">
        ...
        <CollapsibleSection title="Clearcoat">
          <PBRSliderRow label="Clearcoat"  value={clearcoat} min={0} max={1} step={0.05} scale={100} unit="%" disabled={isProtected} onChange={(v: any) => updateProp('clearcoat', v)}          onScrub={(v: any) => updateProp('clearcoat', v)} />
          <PBRSliderRow label="Clearcoat Roughness"   value={ccRough}   min={0} max={1} step={0.05} scale={100} unit="%" disabled={isProtected} onChange={(v: any) => updateProp('clearcoatRoughness', v)} onScrub={(v: any) => updateProp('clearcoatRoughness', v)} />
        </CollapsibleSection>
        ...
        <CollapsibleSection title="Transmission">
          ...
          <PBRSliderRow label="Transmission"  value={transmission} min={0} max={1} step={0.05} scale={100} unit="%" disabled={isProtected} onChange={(v: any) => updateProp('transmission', v)} onScrub={(v: any) => updateProp('transmission', v)} />
          <PBRSliderRow label="IOR"       value={ior}          min={1} max={2.333} step={0.01} disabled={isProtected || !isTransmissive} onChange={(v: any) => updateProp('ior', v)} onScrub={(v: any) => updateProp('ior', v)} />
          {isTransmissive && (
          ...
          <PBRSliderRow label="Thickness"  value={thickness}           min={0} max={10} step={0.1} disabled={isProtected || !isTransmissive} onChange={(v: any) => updateExtProp('thickness', v)}           onScrub={(v: any) => updateExtProp('thickness', v, true)} />
          ...
          <PBRSliderRow label="Attenuation Distance" value={attenuationDistance} min={0} max={10} step={0.1} disabled={isProtected || !isTransmissive} onChange={(v: any) => updateExtProp('attenuationDistance', v)} onScrub={(v: any) => updateExtProp('attenuationDistance', v, true)} />
        </CollapsibleSection>
        ...
        {activeMat && (
          <CollapsibleSection title="Texture Placement">
            ...
            <PBRSliderRow label="Rotation" value={uv?.rotation ?? 0}
              ...
              onChange={(v: any) => setMaterialUv(activeMat.id, 'rotation', v)}
              onScrub={(v: any)  => setMaterialUv(activeMat.id, 'rotation', v, true)} />
          </CollapsibleSection>
        )}
          ...
          <CollapsibleSection title="Advanced">
            ...
            <FieldRow label="Cull Mode">
              <SelectField value={cullMode} options={['back', 'front', 'none']}
                onChange={(v: any) => !isProtected && updateExtProp('cullMode', v)} />
            </FieldRow>
            <FieldRow label="Render Order">
              <NumberField value={renderOrder} step={1}
                onChange={(v: any)  => !isProtected && updateExtProp('renderOrder', Math.round(v))}
                onScrub={(v: any)   => !isProtected && updateExtProp('renderOrder', Math.round(v), true)} />
            </FieldRow>
          </CollapsibleSection>
        )}
      </div>
